									...
									<c:forEach items="${pageInfo.list}" var="UserInfo">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/user/findById.do?id=${UserInfo.id}" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?id=${UserInfo.id}" class="btn bg-olive btn-xs">添加角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
